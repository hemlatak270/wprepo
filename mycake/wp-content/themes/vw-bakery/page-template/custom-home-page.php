              ...
              <div class="carousel-caption">
                <div class="inner_carousel">
                  <div class="inner-carousel-conetnt">
                    ...
                    <p class="wow rollIn" data-wow-duration="3s"><?php $excerpt = get_the_excerpt(); echo esc_html( vw_bakery_string_limit_words( $excerpt, esc_attr(get_theme_mod('vw_bakery_slider_excerpt_number','20')))); ?></p>
